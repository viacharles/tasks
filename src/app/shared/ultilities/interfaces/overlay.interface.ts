...
import { EAction, EFeedbackType } from '../enums/common.enum';
...
export interface IWarnDialogParams {
  type?: EFeedbackType;
  title?: string;
  innerHTML?: string;
  buttons?: {
...
export interface ISelectDropdownParams {
  width?: number;
  height: number;
  options: IOption[];
  alignTo: IAlign;
...
export interface IMultiSelectDropdownParams extends ISelectDropdownParams {
  hasFilter: boolean,
